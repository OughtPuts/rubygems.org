...
ActiveRecord::Schema[8.1].define(version: 2026_06_01_000100) do
  ...
  create_table "versions", id: :serial, force: :cascade do |t|
    ...
    t.index ["canonical_number", "rubygem_id", "platform", "required_ruby_version"], name: "index_versions_on_canonical_rubygem_platform_ruby", unique: true
    ...
    t.index ["rubygem_id", "number", "platform", "required_ruby_version"], name: "index_versions_on_rubygem_number_platform_ruby", unique: true
